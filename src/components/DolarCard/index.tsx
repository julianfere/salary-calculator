...
const DolarCard = () => {
  ...
  if (isLoading) return (<Card><Typography variant="subtitle1" color={'black'}>Fetching values...</Typography></Card>)
  if (error) return (<Card><Typography variant="subtitle1" color={'black'}>Error fetching values</Typography></Card>)

  return (
    <Card>
      <>
      <Typography variant="h6" color={'black'} textAlign="center">Today dolar value</Typography>
